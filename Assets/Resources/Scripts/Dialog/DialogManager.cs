...
public sealed class DialogManager
{
    ...
    public void Pop()
    {
		if (_currentDialog != null){
        	_currentDialog.Close(
				delegate {
                    /*print("123");
                    Animator animator = _currentDialog.GetComponent<Animator>();
	...
	private void ShowNext()
    {
		...
		_currentDialog.Show( delegate {
            //_currentDialog.transform.GetChild(0).GetComponent<EasyTween>().OpenCloseObjectAnimation();
            //_currentDialog.GetComponent<EasyTween>().OpenCloseObjectAnimation();
        } );
